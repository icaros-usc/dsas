...
def log_individual(algorithm_instance, algorithm_name, scenario, elite_map_config):
    ...
    record += [scenario.features[0]] + [scenario.features[1]]
...
def run_trial(
    ...
    feature_map = FeatureMap(
        num_to_evaluate, feature_ranges, resolutions=(MAP_SIZE_1, MAP_SIZE_2)
    )
    if algorithm_name == "CMAES":
        ...
        print ("Start Running Isoline DD")
        mutation_power_pos_1 = algorithm_config["mutation_power_pos_1"]
        mutation_power_disturb_1 = algorithm_config["mutation_power_disturb_1"]
        mutation_power_pos_2 = algorithm_config["mutation_power_pos_2"]
        mutation_power_disturb_2 = algorithm_config["mutation_power_disturb_2"]
        initial_population = algorithm_config["initial_population"]
        algorithm_instance = IsolineDDAlgorithm(
        ...
        algorithm_instance = CMA_ME_Algorithm(
            mutation_power,
            initial_population,
            population_size,
            num_to_evaluate,
