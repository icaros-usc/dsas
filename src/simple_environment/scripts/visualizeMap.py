...
#BC_TYPE = "BC3"
file_name = "ISOLINEDD_BC_sim23_elites_freq20.csv"
ALG_TYPE = "ISOLINEDD"


BC_TYPE = "BC3"

#file_name = "MAPELITES_BC_sim3_elites_freq20.csv"
#ALG_TYPE = "ME"
#file_name = "RANDOM_BC_sim4_elites_freq20.csv"

#file_name = "ISOLINEDD_BC_sim10_elites_freq20.csv"
#ALG_TYPE = "ISOLINEDD"
                ...
                if  i == 499:
                    for data_point in one_map: 
                        if data_point!='':
                            ...
                            featur11e2Range = feature_ranges[1]
                            ...
                            feature1 = float(data_point_info[14])
                            feature2 = float(data_point_info[15])
...
if __name__ == "__main__":
 ...
 #       map[MAP_SIZE_1-1-indx1][indx2] = maxval
        ...
        if ALG_TYPE == "ISOLINEDD":
            plt.title('MAP-Elites (line)')
        elif ALG_TYPE == "CMAES":
            plt.title('CMA-ES')
        ...
        plt.show()
        plt.tight_layout()
        g.figure.savefig(str(BC_TYPE+"_" + ALG_TYPE))
